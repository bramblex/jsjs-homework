...
//     "(() => { let sum = 0; loopTop: for (let i = 0; i < 10; i++) { sum += i; } return sum })()",
//     "(() => { let sum = 0; loopTop1: for (let i = 0; i < 10; i++) { loopTop2: for (let j = 0; j < 2; j++) { sum += j; if (sum === 45) { break loopTop1; }} } return sum })()",
//     "(() => { let sum = 0; loopTop: for (let i = 0; i < 10; i++) { sum += i; break loopTop; } return sum })()",
...
//     } else {
//       const error = t.throws(() => customerEval(sourceCode), {
//         instanceOf: TypeError,
//       });
//       t.is(error.message, "Assignment to constant variable");
//     }
//   }
// });
